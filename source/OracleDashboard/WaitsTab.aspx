...
<body>
    <form id="form1" runat="server">         
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="panel panel-success">
                        <div class="panel-heading"><a target="_blank" href="Waits.aspx?c=<%= ConnectionString %>">Waits</a></div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-success">
                        <div class="panel-heading"><a target="_blank" href="Blocks.aspx?c=<%= ConnectionString %>">Blocks</a></div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="panel panel-success">
                        <div class="panel-heading"><a target="_blank" href="Locks.aspx?c=<%= ConnectionString %>">Locks</a></div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-success">
                        <div class="panel-heading"><a target="_blank" href="LongScans.aspx?c=<%= ConnectionString %>">Long scans</a></div>
